...
const funnelSteps = [
  // --- CAPTURA E VALIDAÇÃO DO NOME PERSONALIZADO ---
  {
    ...
    instructionsForAI: [
      ...
      "1. **Se o lead fornecer um nome preferido claro:** Agradeça brevemente ('Perfeito, [nome]!') e finalize com '[ACTION: ADVANCE_FUNNEL]'",
      "2. **Se o lead fizer uma confirmação simples (sim, pode, ok, tudo bem):** Responda 'Perfeito!' e finalize com '[ACTION: ADVANCE_FUNNEL]'",
      "3. **Se o lead fizer uma PERGUNTA:** Responda 'Entendi sua dúvida. Vou te explicar isso agora mesmo!' e finalize com '[ACTION: ADVANCE_FUNNEL]'",
      "4. **REGRA ESPECIAL:** Palavras como 'pode', 'sim', 'ok', 'tudo bem' NÃO são nomes - são confirmações para usar {firstNameFallback}",
      "",
      "**REGRAS CRÍTICAS:**",
      "- SEMPRE responda algo antes de colocar [ACTION: ADVANCE_FUNNEL]",
      "- NUNCA envie APENAS a tag sem resposta",
      "- Mantenha respostas curtas e objetivas",
      "- Esta etapa é para captura de nome, mas sempre seja educado",
      "- Perguntas serão respondidas na próxima etapa, mas confirme que entendeu",
      "",
      "**EXEMPLOS:**",
      "- Lead: 'oi' → 'Boa noite, aqui é o Pedro do DPA. Tudo bem? Vi que seu nome aqui no WhatsApp é usuário. Posso te chamar assim, ou prefere outro nome?'",
      "- Lead: 'pode' → 'Perfeito! [ACTION: ADVANCE_FUNNEL]'",
      "- Lead: 'Quanto custa?' → 'Entendi sua dúvida. Vou te explicar isso agora mesmo! [ACTION: ADVANCE_FUNNEL]'",
      "- Lead: 'Me chama de Maria' → 'Perfeito, Maria! [ACTION: ADVANCE_FUNNEL]'",
      "",
    ...
    coreQuestionPrompt: "Vi que seu nome aqui é {contactName}. Posso te chamar assim, ou prefere outro nome?",
  ...
  // --- INÍCIO DO FUNIL ---
  {
    ...
    instructionsForAI: [
      ...
      "**DECISÃO DE AVANÇO (Uso da Tag [ACTION: ADVANCE_FUNNEL]):** Use a tag quando o lead der permissão para continuar. **IMPORTANTE: SEMPRE responda positivamente primeiro ('Perfeito!' ou 'Ótimo!') e depois adicione a tag [ACTION: ADVANCE_FUNNEL].**",
    ],
    coreQuestionPrompt:
  ...
  },
  {
    ...
    instructionsForAI: [
      ...
      "**DECISÃO DE AVANÇO (Uso da Tag [ACTION: ADVANCE_FUNNEL]):** QUANDO o lead responder à sua pergunta principal, confirme que entendeu ('Entendi, {contactName}!') e finalize com `[ACTION: ADVANCE_FUNNEL]`."
         ],
  ...
  },
  {
    ...
    instructionsForAI: [
      ...
      "**DECISÃO DE AVANÇO (Uso da Tag [ACTION: ADVANCE_FUNNEL]):** Após o lead responder sobre sua dificuldade principal, confirme que entendeu a dificuldade ('Entendi, {contactName}. Essa dificuldade com [dificuldade] realmente impacta muitos advogados.') e finalize com `[ACTION: ADVANCE_FUNNEL]`.",
    ],
    coreQuestionPrompt:
  ...
  // --- EXPLORAÇÃO DO IMPACTO DO PROBLEMA ---
  {
    ...
    instructionsForAI: [
      ...
      "**DECISÃO DE AVANÇO (REGRA CRÍTICA):** Assim que o lead descrever o impacto da dificuldade (ex: 'perco tempo', 'sinto insegurança'), confirme que entendeu o impacto ('Entendo, {contactName}. Esse impacto realmente é significativo.') e finalize com `[ACTION: ADVANCE_FUNNEL]`.",
    ],
  ...
  // --- APRESENTAÇÃO DA SOLUÇÃO ---
  {
    ...
    instructionsForAI: [
      ...
      "   Responda positivamente ('Perfeito! Vou enviar agora.') e finalize com `[ACTION: ADVANCE_FUNNEL]`.",
      "   Exemplo de resposta CORRETA: `Perfeito! Vou enviar agora. [ACTION: ADVANCE_FUNNEL]`",
      "",
      "🔴 **SE A RESPOSTA FOR NEGATIVA** (incluindo 'não', 'agora não', 'depois', 'não obrigado'):",
      "   Responda com compreensão ('Entendo! Sem problemas.') e finalize com `[ACTION: SKIP_SOCIAL_PROOF]`.",
      "   Exemplo de resposta CORRETA: `Entendo! Sem problemas. [ACTION: SKIP_SOCIAL_PROOF]`",
      "",
      "**REGRA FINAL:** SEMPRE responda de forma educada antes da tag para manter a naturalidade da conversa.",
    ],
    coreQuestionPrompt:
  ...
  // --- ENTREGA DE PROVA SOCIAL ---
  {
    ...
    instructionsForAI: [
      ...
      "   - **SE O LEAD RESPONDER POSITIVAMENTE À SUA PERGUNTA DE TRANSIÇÃO** (ex: 'sim', 'pode apresentar', 'qual a oferta?', 'vamos lá'): Responda positivamente ('Perfeito! Vou apresentar agora.') e finalize com `[ACTION: ADVANCE_FUNNEL]`.",
  ...
  // --- OFERTA DE PLANOS (Neste caso, oferta do curso único) ---
  {
    ...
    instructionsForAI: [
      ...
      "**DECISÃO DE AVANÇO:** Quando o lead concordar em receber o link, confirme ('Perfeito! Vou enviar o link agora.') e finalize com `[ACTION: ADVANCE_FUNNEL]`.",
    ],
    coreQuestionPrompt:
  ...
  // --- FECHAMENTO DA VENDA ---
  {
    ...
    instructionsForAI: [
      ...
      "   - **SE O LEAD CONFIRMAR O PAGAMENTO**: Parabenize ('Excelente! Parabéns pela decisão!') e finalize com `[ACTION: ADVANCE_FUNNEL]`.",
  ...
  // --- PÓS-COMPRA, SUPORTE, ONBOARDING ---
  {
    ...
    instructionsForAI: [
      ...
      "**DECISÃO DE AVANÇO:** Após enviar a mensagem de boas-vindas, se o lead agradecer ou confirmar, responda positivamente ('Muito obrigado! Tenho certeza que será um sucesso!') e finalize com `[ACTION: ADVANCE_FUNNEL]`.",
    ],
